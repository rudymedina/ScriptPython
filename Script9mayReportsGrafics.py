...
labels_temp = {'t1': 'СР температуре Склад 1', 't2': 'СР температуре Склад 2', 't3': 'СР температуре Склад 3'}
...
plt.yticks(np.arange(1, 15, step=1))  # Definir los valores en el eje Y
...
plt.legend()
plt.title('Данные о температуре с 30.08.2023 До 31.08.2023')
plt.tight_layout()
plt.show()
