...
labels_temp = {'t1': 'Температура камера 1', 't2': 'Температура камера 2', 't3': 'Температура камера 3'}
#labels_temp = {'t1': 'Температура камера 1'}
...
plt.yticks(np.arange(18, 25, step=1))  # Definir los valores en el eje Y
...
plt.legend()
plt.title('Данные о температуре с 10 Ноябрь 2023 До 15 Ноябрь 2023')
plt.tight_layout()
plt.show()